...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Eucoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"eucoin.info", "seed.eucoin.info"},
    /*{"Eucointools.com", "dnsseed.Eucointools.com"},
    {"Eucoinpool.org", "dnsseed.Eucoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"eucoin.info", "testnet-seed.eucoin.info"},
    /*{"Eucointools.com", "testnet-seed.Eucointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Eucoin is probably already running."), addrBind.ToString().c_str());
        else
